...
<html>
  <head>
    ...
    <title>Linux Cheatsheet by DavidCWebs</title>
  </head>
  ...
  <body>
    ...
    <header>
      <div class="container">
        <h1>David's Handy Linux Cheat Sheet</h1>
...
This cheatsheet contains commands for Ubuntu, but they should work for any debian based Linux flavour. Maintained by @DavidCWebs - get in touch with me: david@carawebs.com.
